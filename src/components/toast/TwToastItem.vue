...
<template>
  <div :class="type">
    <transition name="toast">
      <div
        class="text-center relative text-gray-800"
        @mouseenter="hover = true"
        @mouseleave="hover = false"
      >
        <div
          class="py-3 pt-1 px-2 shadow bg-opacity-95 rounded relative max-h-60 overflow-y-auto bg-white border-t-8"
          :class="classType"
        >
          <div
            ...
            @click="removeToast()"
          >
            <TwFeather class="text-gray-900" type="x" />
          </div>
        ...
        <div
          v-if="showLifetime"
          class="bg-gray-900 bg-opacity-40 h-[0.35rem] absolute bottom-0 rounded-b-md mx-auto"
          :class="{
